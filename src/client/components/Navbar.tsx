...
const NavBar: React.FC<NavBarProps> = (props) =>{
    return(
        <nav className="nav justify-content-center bg-light shadow p-3 mb-5 ">
            ...
            <NavLink className="text-dark font-weight-bold mx-5" to='/login'> Login</NavLink>
            <NavLink className="text-dark font-weight-bold mx-5" to='/register'> New User</NavLink>
        </nav>
